...
pygame.display.set_caption('CAR GAME (By Uday)')
...
while running:
    ...
    text1 = font.render('High Score: ' + str(hscore), True, yellow)
    text_rect = text.get_rect()
    text1_rect = text1.get_rect()
 
    text_rect.center = (500, 400)
    text1_rect.center = (500, 450)
    ...
    if gameover:
        ...
        text1 = font.render('Your Final Score : '+ str(score)+' & High score : '+str(hscore), True, white)
        text_rect = text.get_rect()
        text1_rect = text1.get_rect()
        text_rect.center = (width / 2, 100)
        text1_rect.center = (width / 2, 150)
